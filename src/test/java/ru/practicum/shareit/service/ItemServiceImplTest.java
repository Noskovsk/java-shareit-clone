...
public class ItemServiceImplTest {
    ...
    void shouldReturnOneItemOfUser() {
        ...
        assertEquals(1, itemService.getItemByUserId(userList.get(1).getId(), null, null).size(), "Количество вещей не совпадает");
    }
    ...
    void shouldSearchByString() {
        ...
        assertEquals(1, itemService.searchItems("ItemDesc1", null, null).size(), "Количество вещей не совпадает");
    }
